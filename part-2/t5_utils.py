...
def setup_wandb(args):
    ...
    wandb.init(entity="ra4633-new-york-university", project='NLP-hw4-part2', name=args.experiment_name, config=vars(args))
...
def save_model(checkpoint_dir, model, best):
    ...
    model_save_path = os.path.join(checkpoint_dir, "best" if best else "last")
...
def load_model_from_checkpoint(args, best):
    ...
    checkpoint_dir = os.path.join('checkpoints', f'{model_type}_experiments', args.experiment_name, 'best' if best else 'last')

...
def create_augmented_dataloader(args, dataset):
    ...
    augmented_train_dataset = datasets.concatenate_datasets([dataset["train"], transformed_subset])
    augmented_tokenized_dataset = augmented_train_dataset.map(tokenize_function, batched=True, load_from_cache_file=False)
